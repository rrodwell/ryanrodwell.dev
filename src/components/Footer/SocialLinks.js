  ...
  return (
    <div className="container">
      ...
      <div className="text-muted mx-5 my-4 h3 text-justify info">
        A Software Developer, Consultant, Technology Enthusiast, and an Apple
        Fanboy.
        <br />
        Always exploring new technologies and finding ways it can help improve
        my ability to design and create.
      </div>
